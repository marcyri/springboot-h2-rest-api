...
class AttendanceMapperTest {
    ...
    @Spy
    private AttendanceMapStruct attendanceMapStruct = Mappers.getMapper(AttendanceMapStruct.class);
    @Spy
    private PatientMapStruct patientMapStruct = Mappers.getMapper(PatientMapStruct.class);
